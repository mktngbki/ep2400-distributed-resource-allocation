...
public class CopyOfDistributedResourceAllocationOld extends DistributedPlacementProtocol {
	...
	public CopyOfDistributedResourceAllocationOld(String prefix) {
		super(prefix);
	...
	public CopyOfDistributedResourceAllocationOld(String prefix, double cpu_capacity_value) {
	...
	public void nextCycle(Node node, int protocolID) {
		...
		CopyOfDistributedResourceAllocationOld n_prime = (CopyOfDistributedResourceAllocationOld) peer.getProtocol(protocolID);
...
//		}
	...
	@Override
	public Object clone() {
		CopyOfDistributedResourceAllocationOld proto = new CopyOfDistributedResourceAllocationOld(prefix, cpuCapacity);
		return proto;
	}
}